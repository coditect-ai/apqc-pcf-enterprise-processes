---
title: Claude Context - Consumer Products PCF
type: reference
component_type: reference
version: 1.0.0
audience: contributor
status: pending
summary: AI context for Consumer Products industry PCF analysis
keywords:
- APQC
- PCF
- consumer-products
...
# Consumer Products PCF - Claude Context

## Purpose

This directory contains the APQC Process Classification Framework (PCF) for the Consumer Products industry, pending decomposition into structured markdown for AI applicability analysis.
...
```bash
/agent pcf-decomposer "consumer-products"
```
