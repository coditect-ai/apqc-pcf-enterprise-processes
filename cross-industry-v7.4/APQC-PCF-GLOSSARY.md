---
title: APQC PCF Complete Glossary
type: research-analysis
component_type: glossary
version: 1.0.0
audience: contributor
status: active
summary: Complete definitions for all 1,856 APQC PCF process elements
keywords:
- APQC-PCF
- glossary
- definitions
...
This glossary provides official APQC definitions for every process element in the Process Classification Framework. Definitions explain the scope, activities, and purpose of each process.
...
- [1.0 - Develop Vision and Strategy](#10---develop-vision-and-strategy)
- [2.0 - Develop and Manage Products and Services](#20---develop-and-manage-products-and-services)
- [3.0 - Market and Sell Products and Services](#30---market-and-sell-products-and-services)
- [4.0 - Deliver Physical Products](#40---deliver-physical-products)
- [5.0 - Deliver Services](#50---deliver-services)
- [6.0 - Manage Customer Service](#60---manage-customer-service)
- [7.0 - Develop and Manage Human Capital](#70---develop-and-manage-human-capital)
- [8.0 - Manage Information Technology (IT)](#80---manage-information-technology-(it))
- [9.0 - Manage Financial Resources](#90---manage-financial-resources)
- [10.0 - Acquire, Construct, and Manage Assets](#100---acquire-construct-and-manage-assets)
- [11.0 - Manage Enterprise Risk, Compliance, Remediation, and Resiliency](#110---manage-enterprise-risk-compliance-remediation-and-resiliency)
- [12.0 - Manage External Relationships](#120---manage-external-relationships)
- [13.0 - Develop and Manage Business Capabilities](#130---develop-and-manage-business-capabilities)
