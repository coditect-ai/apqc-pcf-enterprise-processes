---
title: Claude Context - City Government PCF
type: reference
component_type: reference
version: 1.0.0
audience: contributor
status: pending
summary: AI context for City Government industry PCF analysis
keywords:
- APQC
- PCF
- city-government
...
# City Government PCF - Claude Context

## Purpose

This directory contains the APQC Process Classification Framework (PCF) for the City Government industry, pending decomposition into structured markdown for AI applicability analysis.
...
```bash
/agent pcf-decomposer "city-government"
```
